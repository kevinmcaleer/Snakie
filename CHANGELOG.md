...
**Do not edit this file in a feature branch.** Add a fragment in `changelog.d/`
instead (`npm run changelog -- new added "…" --issue N`); it is folded in here
when a release is cut. See `changelog.d/README.md`.
...
[Unreleased]: https://github.com/kevinmcaleer/Snakie/compare/v0.91.0...HEAD
[0.91.0]: https://github.com/kevinmcaleer/Snakie/compare/v0.85.4...v0.91.0
