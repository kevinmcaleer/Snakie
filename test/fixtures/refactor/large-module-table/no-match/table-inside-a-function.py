"""The table is built inside the function, so it is collected when it returns."""


def gamma_ramp():
    """Build the 96-entry ramp on demand, then throw it away."""
    return [
        ...
        252, 255, 2, 5, 8, 11, 14, 17, 20, 23, 26, 29,
    ]


def apply_ramp(panel):
    for level in gamma_ramp():
        panel.write(level)
