 ...
 * registered rule has no fixtures.
 */
...
/**
 * §3.6 + §3.8 — MicroPython-specific. Nothing else on the market offers these,
 * and they are the ones that actually make a robot work better. Several are
 * latent bugs rather than style opinions (a raw tick subtraction WILL misbehave
 * when the counter wraps), which is why this family's hints are on by default.
 */
