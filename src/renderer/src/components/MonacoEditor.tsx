...
// The theme + metrics helpers moved to `monaco-theme.ts` (#1010) when the
// blocks split gained a read-only Python mirror: "the same theme and font as the
// editor" is only guaranteed if there is one implementation of what those are.
import {
  editorMetricsFor,
  ensureMonacoThemes,
  monacoTheme,
